...
export default function Home() {
  ...
  // Wayfern terms remain required by the bundled browser.
  const {
    termsAccepted,
  ...
  const [syncPageOpen, setSyncPageOpen] = useState(false);
  ...
  // Check the self-hosted sync configuration on mount.
  useEffect(() => {
